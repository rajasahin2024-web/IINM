...
.cp-card{background:#fff;border-radius:0;border:1px solid #e2e8f0;padding:22px;box-shadow:0 2px 8px rgba(0,0,0,.04);margin-bottom:20px}
...
.fi-field{position:relative;border:1.5px solid #e2e8f0;border-radius:0;background:#f8fafc;transition:border-color .2s, box-shadow .2s, background .2s}
...
.fi-inp{display:block;width:100%;border:none;background:transparent;outline:none;padding:16px 14px;font-size:14px;color:#0f172a;font-family:inherit;font-weight:500;box-sizing:border-box;border-radius:0}
...
.stu-drop{position:absolute;top:calc(100% + 4px);left:0;right:0;z-index:200;background:#fff;border:1.5px solid #e2e8f0;border-radius:0;box-shadow:0 8px 24px rgba(0,0,0,.1);overflow:hidden}
...
.btn-primary{border:none;background:#6366f1;color:#fff;font-weight:700;font-size:14px;cursor:pointer;border-radius:0;display:flex;align-items:center;justify-content:center;gap:8px;transition:all .2s;box-shadow:0 4px 14px rgba(99,102,241,.3)}
...
.btn-outline{border:1.5px solid #6366f1;background:#eef2ff;color:#6366f1;font-weight:700;font-size:12px;cursor:pointer;border-radius:0;display:flex;align-items:center;gap:5px;transition:all .2s;white-space:nowrap;flex-shrink:0}
.btn-outline:hover{background:#e0e7ff}
.badge{display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:0;font-size:11px;font-weight:700}
...
.toggle-switch{position:relative;width:40px;height:24px;background:#e2e8f0;border-radius:0;cursor:pointer;transition:background .2s}
.toggle-switch.on{background:#10b981}
.toggle-thumb{position:absolute;top:2px;left:2px;width:20px;height:20px;background:#fff;border-radius:0;transition:transform .2s;box-shadow:0 1px 3px rgba(0,0,0,.1)}
.toggle-switch.on .toggle-thumb{transform:translateX(16px)}
@media(max-width:640px){
  .cp-card{padding:14px}
  .fi-field{border-radius:0}
  .fi-inp{padding:14px 12px;font-size:15px}
